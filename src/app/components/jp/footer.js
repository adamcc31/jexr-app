                    ...
                    <div className="row align-items-center">
                        ...
                        {/* <div className="col-sm-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
                            <ul className="list-unstyled social-icon foot-social-icon text-sm-end mb-0">
                                <li className="list-inline-item"><Link href="https://1.envato.market/J Expert-next" target="_blank" className="rounded"><FiShoppingCart className="fea icon-sm align-middle" /></Link></li>
