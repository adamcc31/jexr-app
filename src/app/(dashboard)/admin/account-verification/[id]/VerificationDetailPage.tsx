...
import { JapanWorkExperience, VerificationStatus } from '@/lib/api/verification';
...
export default function VerificationDetailPage({ id }: VerificationDetailPageProps) {
    ...
    const formatWorkPeriod = (exp: JapanWorkExperience) => {
                        ...
                        <div className="card-body">
                            {experiences.length === 0 ? (
                                ...
                                <div className="d-flex flex-column gap-4">
                                    {experiences.map((exp) => (
                                        <div key={exp.id} className="border-start border-3 border-primary ps-3">
