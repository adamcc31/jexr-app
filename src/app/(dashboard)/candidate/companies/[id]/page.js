...
export default function EmployerProfile({ params }) {
    let data = jobData.find((job) => job.id === parseInt(params.id))
    return (
        <>
                            ...
                            <div className="features-absolute">
                                <div className="d-md-flex justify-content-between align-items-center bg-white shadow rounded p-4">
                                    ...
                                    <div className="mt-4 mt-md-0">
                                        ...
                                        <Link href="/candidate/jobs" className="btn btn-sm btn-soft-primary">See Jobs</Link>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    return (
                                        <div className="col-lg-6 col-12" key={index}>
                                            <div className="job-post rounded shadow bg-white">
                                                <div className="p-4">
                                                    <Link href={`/candidate/jobs/${item.id}`} className="text-dark title h5">{item.title}</Link>
                        ...
                        <div className="col-lg-4 col-md-5 col-12">
                            <div className="card bg-white p-4 rounded shadow sticky-bar">
                                <div className="map map-400px border-0">
                                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d39206.002432144705!2d-95.4973981212445!3d29.709510002925988!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8640c16de81f3ca5%3A0xf43e0b60ae539ac9!2sGerald+D.+Hines+Waterwall+Park!5e0!3m2!1sen!2sin!4v1566305861440!5m2!1sen!2sin" className="rounded" style={{ border: '0' }} title="J Expert" allowFullScreen></iframe>
                                </div>
                                ...
                                <div className="col-lg-3 col-md-4 col-sm-6 col-12 mt-5" key={index}>
                                    <div className="employer-card position-relative bg-white rounded shadow p-4 mt-3">
                                        ...
                                        <div className="content mt-3">
                                            <Link href={`/candidate/companies/${item.id}`} className="title text-dark h5">{item.name}</Link>
