                    ...
                    <div className="row justify-content-center">
                        <div className="col-12">
                            <div className="section-title text-center mb-4 pb-2">
                                ...
                                <p className="para-desc mx-auto text-muted">We are a huge marketplace dedicated to connecting great artists of all J Expert with their fans and unique token collectors!</p>
                            </div>
                        </div>
                    </div>
