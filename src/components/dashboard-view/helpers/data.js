import { invoicesData, referralsData } from '@/assets/dashboard-assets/data/apps';
import { activityData, contactListData, orders, orderStatus, pricingPlans, timelineData, users } from '@/assets/dashboard-assets/data/other';
import { sleep } from '@/components/dashboard-view/utils/promise';
